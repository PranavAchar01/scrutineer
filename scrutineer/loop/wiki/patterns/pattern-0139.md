# pattern-0139 — AERO — 1.2-tool-schema-error

role: AERO
mast_mode: 1.2-tool-schema-error
generation: 1
evidence:
...
2 lap(s) this generation failed with 1.2-tool-schema-error. Correcting AERO alone flipped them, so the cause is the artifact, not the driver.
