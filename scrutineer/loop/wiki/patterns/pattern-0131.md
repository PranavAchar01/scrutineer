# pattern-0131 — AERO — 1.4-loss-of-history
...
3 lap(s) this generation failed with 1.4-loss-of-history. Correcting AERO alone flipped them, so the cause is the artifact, not the driver.
